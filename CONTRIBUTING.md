...
The documentation in `/docs` is generated using the `tfplugindocs` tool, see [terraform-plugin-docs](https://github.com/hashicorp/terraform-plugin-docs). To generate documentation run:
