...
The main focus is on establishing projects and environments by using the [SitecoreAI Deploy API](https://xmclouddeploy-api.sitecorecloud.io/swagger/index.html)
...
All improvements and contributions are very welcome, see [CONTRIBUTING.md](./CONTRIBUTING.md) on details about building and running the project.
